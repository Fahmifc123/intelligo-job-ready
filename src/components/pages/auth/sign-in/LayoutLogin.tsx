...
export const LayoutLogin = ({onFormSubmit, loading, errorMessage}: Props) => {
  return (
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6">
            ...
            <div className="text-center mb-6">
              ...
              {/* Title Section */}
              <div className="mb-4">
                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Professional Development</p>
            ...
            {/* Login Form */}
            <SignInForm onFormSubmit={onFormSubmit} loading={loading} errorMessage={errorMessage} />
          </div>
        </div>
